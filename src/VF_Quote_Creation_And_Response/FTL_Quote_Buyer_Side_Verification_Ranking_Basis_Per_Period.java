...
public class FTL_Quote_Buyer_Side_Verification_Ranking_Basis_Per_Period {
	...
	public  void Open_Quote_In_Active_Tab() throws Exception{
		...
		try {
			...
			WebElement activequotes=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[2]/div/div/div/div[2]/div/ul/li[2]/span[2]"));
			activequotes.click();
			Thread.sleep(3000);
