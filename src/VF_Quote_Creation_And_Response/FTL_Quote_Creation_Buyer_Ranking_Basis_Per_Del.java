...
public class FTL_Quote_Creation_Buyer_Ranking_Basis_Per_Del {
	...
	public void setUp(){
		...
		htmlReporter= new ExtentHtmlReporter("../Veri-Fuel_Hybrid_Framework/FTL Freight Only/FTL_Quote_Creation_Buyer_Ranking_Basis_$_Per_Del.html");
	...
	public  void verify_buyer_login() throws Exception{
		...
		try {
			...
			if(newquote.isDisplayed()){
				System.out.println("\n"+ ExcelUtils.getCellData(5, colnum) + " Buyer logged in successfully");
				test1.pass(ExcelUtils.getCellData(5, colnum) + " Buyer Logged in Succesfully");
				
			}
			else{
				System.out.println("Buyer logged in Unsuccessful");
				test1.fail(ExcelUtils.getCellData(5, colnum) + " Buyer Loggedin is not Succesfully");
