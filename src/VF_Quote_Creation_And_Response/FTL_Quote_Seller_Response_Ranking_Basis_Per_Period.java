...
public class FTL_Quote_Seller_Response_Ranking_Basis_Per_Period {
	...
	public  void Verify_Fuelsurcharge_And_Accessorial_Service_on_Workbench() throws Exception{
		...
		try {
			...
			if(actualaccessoriesfees.equalsIgnoreCase(expectedfuelaccessoriesfees)){
				...
				System.out.println("Accessorial Fees value in Workbencg is not validated and value is " + accessoriesfees.getText());
				test1.fail("Accessorial Fees value in Workbencg is not validated and value is " + accessoriesfees.getText());
	...
	public  void Verify_finaltotal_and_RankingBasis_Values() throws Exception{
		...
		try {
			...
			ExcelUtils.setCellData(numberAsString, 134, colnum);
