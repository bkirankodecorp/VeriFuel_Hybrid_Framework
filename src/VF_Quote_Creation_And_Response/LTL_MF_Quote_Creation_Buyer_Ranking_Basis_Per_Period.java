...
public class LTL_MF_Quote_Creation_Buyer_Ranking_Basis_Per_Period {
	...
	public void setUp(){
		...
		htmlReporter= new ExtentHtmlReporter("../Veri-Fuel_Hybrid_Framework/LTL Mobile Fueling/LTL_Quote_Buyer_Creation__Ranking_Basis_$_Per_Period.html");
	...
	public  void verify_buyer_login() throws Exception{
		...
		try {
			...
			if(newquote.isDisplayed()){
				...
				test1.pass(ExcelUtils.getCellData(5, 4) + " Buyer logged in successfully");

			}
			else{
				System.out.println("Buyer logged in Unsuccessful");
				test1.fail("Buyer logged in Unsuccessful");
	...
	public  void Enter_Details_In_Tand() throws Exception{
		...
		try {
			...
			WebElement ltlmobilefueling=driver.findElement(By.xpath("//*[@id='expandallltlequp']/label[1]"));
			WebElement ltltankwagon=driver.findElement(By.xpath("//*[@id='expandallltlmeter']/label[1]"));


			try {

				if (ltlmobilefueling.isDisplayed()) {

					WebElement expandall=driver.findElement(By.xpath("//*[@id='expandallltlequp']/label[1]"));
					expandall.click();
					Thread.sleep(2000);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement usageperiod=driver.findElement(By.id("Rfpviewmodel_Terms_GallonsPeriod"));
					...
					executor13.executeScript("arguments[0].click();", productcategory);
					...
					WebElement prodsubcat1cell=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr/td[2]"));
					...
					WebElement div=driver.findElement(By.xpath("//*[@id='equpreq']/div[1]"));

					WebElement estgallonsperiodcell=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr/td[6]"));
					...
					test1.info("Estimated Gallons/Period is " + ExcelUtils.getCellDataNum(32, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement estdelperiodcell=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr/td[7]"));
					JavascriptExecutor executor2 = (JavascriptExecutor)driver;
					executor2.executeScript("arguments[0].click();", estdelperiodcell);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement estdelperiod=driver.findElement(By.id("DeliveriesPerPeriod"));
					estdelperiod.sendKeys(ExcelUtils.getCellData(33, colnum));
					test1.info("Estimated Del/Period is " + ExcelUtils.getCellData(33, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement unittypecell=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr/td[8]"));
					JavascriptExecutor executor3 = (JavascriptExecutor)driver;
					executor3.executeScript("arguments[0].click();", unittypecell);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement unitypecelldropdown=driver.findElement(By.xpath("//span[@aria-owns='UnitTypeID_listbox']//span[@class='k-icon k-i-arrow-60-down']"));
					unitypecelldropdown.click();
					Thread.sleep(2000);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					By mySelector2 = By.xpath(".//*[@id='UnitTypeID_listbox']");
					List<WebElement> myElements2 = driver.findElements(mySelector2);
					for(WebElement e : myElements2) {
						System.out.println("unit type Has Following Dropdown List \n" + e.getText());
						test1.info("unit type Has Following Dropdown List \n" + e.getText());
					}

					List<WebElement> unitype=driver.findElements(By.xpath("//ul[@id='UnitTypeID_listbox']//li"));
					for(WebElement ele:unitype)
					{

						String unitypeselect=ele.getText();
						if(unitypeselect.equalsIgnoreCase(ExcelUtils.getCellData(36, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					Thread.sleep(2000);
					System.out.println("Unit Type is " + ExcelUtils.getCellData(36, colnum));
					test1.info("Unit Type is " + ExcelUtils.getCellData(36, colnum));

					WebElement unitscell=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr/td[9]"));
					JavascriptExecutor executor4 = (JavascriptExecutor)driver;
					executor4.executeScript("arguments[0].click();", unitscell);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement units=driver.findElement(By.id("EstimatedAssets"));
					units.sendKeys(ExcelUtils.getCellData(37, colnum));
					test1.info("Unit value is " + ExcelUtils.getCellData(37, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					WebElement productcategory2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[1]/span[1]/span/span[2]/span"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", productcategory2);
					Thread.sleep(2000);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					for(WebElement ele:prodcateory2)
					{
						...
						if(prodcateory2select.equalsIgnoreCase(ExcelUtils.getCellData(42, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					System.out.println("prd.cate. is "+ ExcelUtils.getCellData(42, colnum));
					test1.info("prd.cate. is "+ ExcelUtils.getCellData(42, colnum));

					WebElement productsubcategory2=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr[2]/td[2]"));
					executor.executeScript("arguments[0].click();", productsubcategory2);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement productsubcategoryclick2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[2]/span[1]/span/span[2]/span"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", productsubcategoryclick2);
					Thread.sleep(2000);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					for(WebElement ele:prodcateorysubcate2)
					{
						...
						if(prodcateorysubcateselect2.equalsIgnoreCase(ExcelUtils.getCellData(45, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					Thread.sleep(2000);
					System.out.println("prd.sub cate. is " + ExcelUtils.getCellData(45, colnum));
					test1.info("prd.sub cate. is " + ExcelUtils.getCellData(45, colnum));

					WebElement estgalperperiod2=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr[2]/td[6]"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", estgalperperiod2);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement estgallonsperiod2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[6]/input"));
					estgallonsperiod2.sendKeys(ExcelUtils.getCellData(46, colnum));
					test1.info("Estimated Gollons value is " + ExcelUtils.getCellData(46, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement estdelperperiod2=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr[2]/td[7]"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", estdelperperiod2);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement estdelperiod2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[7]/input"));
					
					estdelperiod2.sendKeys(ExcelUtils.getCellData(47, colnum));
					test1.info("Estimated Del Per Period value is " + ExcelUtils.getCellData(47, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement unitypecell2=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr[2]/td[8]"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", unitypecell2);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement unitypecelldropdown2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[8]/span[1]/span/span[2]/span"));
					unitypecelldropdown2.click();
					Thread.sleep(2000);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					List<WebElement> unitype2=driver.findElements(By.xpath("//ul[@id='UnitTypeID_listbox']//li"));
					for(WebElement ele:unitype2)
					{

						String unitypeselect2=ele.getText();
						if(unitypeselect2.equalsIgnoreCase(ExcelUtils.getCellData(50, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					Thread.sleep(2000);
					System.out.println("Unit Type is " + ExcelUtils.getCellData(50, colnum));
					test1.info("Unit Type is " + ExcelUtils.getCellData(50, colnum));

					WebElement unitscell2=driver.findElement(By.xpath("//*[@id='ProductsGridModify']/div[3]/table/tbody/tr[2]/td[9]"));
					((JavascriptExecutor)driver).executeScript("arguments[0].click();", unitscell2);
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

					WebElement units2=driver.findElement(By.xpath("/html/body/div[5]/div[4]/div/div[1]/div/div[1]/div/div/div/div/div/div[2]/div[3]/div/div[1]/div[3]/div[2]/div[3]/div/div/div/div[3]/table/tbody/tr[2]/td[9]/input"));
					
					units2.sendKeys(ExcelUtils.getCellData(51, colnum));
					test1.info("Unit Value is " + ExcelUtils.getCellData(51, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					div.click();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			...
			try {
				...
				if (ltltankwagon.isDisplayed()) {
					...
					Select usageperiod1= new Select(usageperiod);
					usageperiod1.selectByVisibleText(ExcelUtils.getCellData(48, colnum));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					for(WebElement ele:prodcateory)
					{
						...
						String prodcateoryselect=ele.getText();
						if(prodcateoryselect.equalsIgnoreCase(ExcelUtils.getCellData(52, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					System.out.println("prd.cate. is " + ExcelUtils.getCellData(52, colnum));
					...
					for(WebElement ele:prodcateorysubcate)
					{
						...
						String prodcateorysubcateselect=ele.getText();
						if(prodcateorysubcateselect.equalsIgnoreCase(ExcelUtils.getCellData(55, colnum)))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					System.out.println("prd.sub cate. is " + ExcelUtils.getCellData(55, colnum));
					...
					estgallonsperiod.sendKeys(String.valueOf(ExcelUtils.getCellDataNum(56, colnum)));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					tanksize.clear();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					tanksize.sendKeys(String.valueOf(ExcelUtils.getCellDataNum(57, colnum)));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					for(WebElement ele:prodcateory2)
					{
						...
						String prodcateory2select=ele.getText();
						if(prodcateory2select.equalsIgnoreCase("Gasoline"))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					for(WebElement ele:prodcateorysubcate2)
					{
						...
						String prodcateorysubcateselect2=ele.getText();
						if(prodcateorysubcateselect2.equalsIgnoreCase("Premium"))
						{
							ele.click();
							VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
							break;
					...
					estgallonsperiod2.sendKeys(String.valueOf(ExcelUtils.getCellDataNum(56, colnum)));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					...
					tanksize1.clear();
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
					tanksize1.sendKeys(String.valueOf(ExcelUtils.getCellDataNum(57, colnum)));
					VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
	...
	public  void Select_Payment_and_Service_Schedule_Pattern_in_TandC() throws Exception{
		...
		try {
			...
			Thread.sleep(2000);
			WebElement deliveryhoursfrom=driver.findElement(By.id("Rfpviewmodel_DeliveryHoursFrom"));

			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", deliveryhoursfrom);
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

			WebElement paymenterms=driver.findElement(By.id("Rfpviewmodel_price_PaymentTermsID"));
			Select paymentermsselect= new Select(paymenterms);
			paymentermsselect.selectByVisibleText(ExcelUtils.getCellData(73, colnum));
			test1.info("Payment Term is " + ExcelUtils.getCellData(73, colnum));
			
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			
			WebElement week1serviceselect = driver.findElement(By.id(ExcelUtils.getCellData(74, colnum)));
			week1serviceselect.click();
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			test1.info("Week1 is Monday");			
			
			WebElement week2serviceselect = driver.findElement(By.id(ExcelUtils.getCellData(75, colnum)));
			...
			deliveryhoursfromselect.selectByVisibleText(ExcelUtils.getCellData(76, colnum));
			test1.info("Delivery Hours From are " + ExcelUtils.getCellData(76, colnum));
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

			WebElement deliveryhoursto=driver.findElement(By.id("Rfpviewmodel_DeliveryHoursTo"));
			Select deliveryhourstoselect= new Select(deliveryhoursto);
			deliveryhourstoselect.selectByVisibleText(ExcelUtils.getCellData(77, colnum));
			test1.info("Delivery Hours To are " + ExcelUtils.getCellData(77, colnum));
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);

			WebElement settlethrough=driver.findElement(By.id("Rfpviewmodel_price_BillingAgencyID"));
			Select settlethroughselect= new Select(settlethrough);
			settlethroughselect.selectByVisibleText(ExcelUtils.getCellData(78, colnum));
			test1.info("Settle though " + ExcelUtils.getCellData(78, colnum));
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
	...
	public  void Select_Sellers_for_Draft_Quote() throws Exception{
		...
		try {
			...
			String mainseller=ExcelUtils.getCellData(84, colnum);
			...
			Thread.sleep(2000);
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			test1.info("Main Seller Network is " + ExcelUtils.getCellData(84, colnum));
			...
			sellersearchbox.sendKeys(ExcelUtils.getCellData(85, colnum));
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			...
			VF_Screenshot.LTL_Buyer_Quote_Creation_screenshot.CaptureScreenshot(driver);
			test1.info("Seller is " + ExcelUtils.getCellData(85, colnum));
