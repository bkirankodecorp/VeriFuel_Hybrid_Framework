...
public class LTL_TW_Quote_Seller_Response_Ranking_Basis_Per_Del {
	...
	public void Open_Browser() throws Exception {
		...
		ExcelUtils.setExcelFile(Constant.Path_TestData + Constant.File_TestData,"VF_LTL_TW_Seller_Response");
	...
	public  void Verify_Delivery_Flat_Fee_for_Seller_Freight_Rates_In_TandC() throws Exception{
		...
		try {
			...
			WebElement benchmark=driver.findElement(By.id("LTLTerms_FreightPerDelivery"));
	...
	public  void Verify_Freight_And_Margin_$_Per_Gallon_for_Seller_Freight_Rates_In_TandC() throws Exception{
		...
		try {
			...
			for(int i=1,j=18,k=25; i<=2&&j<=18&&k<=25; i++,j--,k--){
				...
				WebElement frgtpergalvalue=driver.findElement(By.xpath("//*[@id='ProductsLTLGridModify']/div[3]/table/tbody/tr["+i+"]/td[7]"));
			...
			for(int i=1,j=21,k=25; i<=2&&j<=21&&k<=25; i++,j--,k--){
				...
				WebElement margin$pergallon=driver.findElement(By.xpath("//*[@id='ProductsLTLGridModify']/div[3]/table/tbody/tr["+i+"]/td[8]"));
	...
	public  void Retrieve_$_Per_Del_Values_From_TandC() throws Exception{
		...
		try {
			...
			for(int i=1,j=36,k=25; i<=2&&j<=37&&k<=25; i++,j++,k--){
				...
				WebElement $perdel=driver.findElement(By.xpath("//*[@id='ProductsLTLGridModify']/div[3]/table/tbody/tr["+i+"]/td[9]"));
	...
	public  void Retrieve_$_Per_Gal_Values_From_TandC() throws Exception{
		...
		try {
			...
			for(int i=1,j=38,k=25; i<=2&&j<=39&&k<=25; i++,j++,k--){
				...
				WebElement $pergal=driver.findElement(By.xpath("//*[@id='ProductsLTLGridModify']/div[3]/table/tbody/tr["+i+"]/td[10]"));
	...
	public  void Retrieve_$_Per_Period_Values_From_TandC() throws Exception{
		...
		try {
			...
			for(int i=1,j=40,k=25; i<=2&&j<=41&&k<=25; i++,j++,k--){
				...
				WebElement $perperiod=driver.findElement(By.xpath("//*[@id='ProductsLTLGridModify']/div[3]/table/tbody/tr["+i+"]/td[11]"));
	...
	public  void Verify_Delivery_Flat_Fee_for_Seller_Freight_Rates_In_Workbench() throws Exception{
		...
		try {
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.id("ltlCstperdelftPlh")));
			VF_Screenshot.FTL_Seller_Quote_Response_screenshot.CaptureScreenshot(driver);

			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.id("ltlCstperiodftPlh")));
			VF_Screenshot.FTL_Seller_Quote_Response_screenshot.CaptureScreenshot(driver);
			
			WebElement benchmark=driver.findElement(By.id("LTLTerms_WorkbenchFreightPerDelivery"));
	...
	public  void Verify_Freight_And_Margin_$_Per_Gallon_for_Seller_Freight_Rates_In_Workbench() throws Exception{
		...
		try {
			...
			for(int i=1,j=18,k=25; i<=2&&j<=18&&k<=25; i++,j--,k--){
				...
				WebElement frgtpergalvalue=driver.findElement(By.xpath("//*[@id='ProductsLTLBuyerWorkbenchGridModify']/div[3]/table/tbody/tr["+i+"]/td[16]"));
				String expectedfrgtpergalvalue=ExcelUtils.getCellData(j, colnum);
				String actualfrghtpergal=frgtpergalvalue.getText();
				if(actualfrghtpergal.equalsIgnoreCase(expectedfrgtpergalvalue)){
			...
			for(int i=1,j=21,k=25; i<=2&&j<=21&&k<=25; i++,j--,k--){
				...
				WebElement margin$pergallon=driver.findElement(By.xpath("//*[@id='ProductsLTLBuyerWorkbenchGridModify']/div[3]/table/tbody/tr["+i+"]/td[17]"));
	...
	public  void Verify_$_Per_Del_Values_in_Workbench() throws Exception{
		...
		try {
			...
			for(int i=1,j=36,k=25; i<=2&&j<=37&&k<=25; i++,j++,k--){
				...
				WebElement $perdel=driver.findElement(By.xpath("//*[@id='ProductsLTLBuyerWorkbenchGridModify']/div[3]/table/tbody/tr["+i+"]/td[18]"));
			...
			WebElement total$delvalue=driver.findElement(By.id("ltlCstperdelftPlh"));
	...
	public  void Verify_$_Per_Gal_Values_in_Workbench() throws Exception{
		...
		try {
			...
			for(int i=1,j=38,k=25; i<=2&&j<=39&&k<=25; i++,j++,k--){
				...
				WebElement $pergal=driver.findElement(By.xpath("//*[@id='ProductsLTLBuyerWorkbenchGridModify']/div[3]/table/tbody/tr["+i+"]/td[19]"));
			...
			WebElement total$galvalue=driver.findElement(By.id("ltlCstperperiodftPlh"));
	...
	public  void Verify_$_Per_Period_Values_in_Workbench() throws Exception{
		...
		try {
			...
			for(int i=1,j=40,k=25; i<=2&&j<=41&&k<=25; i++,j++,k--){
				...
				WebElement $perperiod=driver.findElement(By.xpath("//*[@id='ProductsLTLBuyerWorkbenchGridModify']/div[3]/table/tbody/tr["+i+"]/td[20]"));
			...
			WebElement total$periodvalue=driver.findElement(By.id("ltlCstperiodftPlh"));
	...
	public  void check_Publish_To_Buyer_Calculator() throws Exception{
		...
		try {
			...
			/*WebElement buyercalculator=driver.findElement(By.xpath("/html/body/div[22]/div[2]/div[1]/div/div/div[2]/div[4]/div/div/div[2]/div/div/div/div/div/div/div/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div/div[2]/div/div[12]/div[2]/span/input[1]"));
			Thread.sleep(2000);
			((JavascriptExecutor)driver).executeScript("arguments[0].click();", buyercalculator);
			VF_Screenshot.FTL_Seller_Quote_Response_screenshot.CaptureScreenshot(driver);*/
			
			int ok_size=driver.findElements(By.id("LTLTerms_IsPublishtoBuyerWB")).size();
			driver.findElements(By.id("LTLTerms_IsPublishtoBuyerWB")).get(ok_size-1).click();
	...
	public  void Get_Values_from_Buyer_Calculator() throws Exception{
		...
		try {
			...
			WebElement truckpumprate=driver.findElement(By.xpath("/html/body/div[22]/div[2]/div[1]/div/div/div[2]/div[4]/div/div/div[2]/div/div/div/div/div/div/div/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div/div[2]/div/div[1]/div/div[1]/input"));
			ExcelUtils.setCellData(truckpumprate.getAttribute("value"), 59, colnum);
			
			System.out.println("Truck Pump Rate is " + truckpumprate.getAttribute("value"));
			test1.info("Truck Pump Rate is " + truckpumprate.getAttribute("value"));

			WebElement StemTime=driver.findElement(By.xpath("/html/body/div[22]/div[2]/div[1]/div/div/div[2]/div[4]/div/div/div[2]/div/div/div/div/div/div/div/div/div[2]/div/div/div[2]/div[3]/div/div[1]/div/div[2]/div/div[2]/div/div[1]/input"));
			ExcelUtils.setCellData(StemTime.getAttribute("value"), 60, colnum);
			

			System.out.println("Stem Time is "+ StemTime.getAttribute("value"));
			test1.info("Stem Time is "+ StemTime.getAttribute("value"));

			WebElement LoadingTime=driver.findElement(By.id("LTLTerms_WorkbenchLoadingTime"));
			ExcelUtils.setCellData(LoadingTime.getAttribute("value"), 61, colnum);
			...
			WebElement AvgFuelingTimeperUnitmins=driver.findElement(By.id("ltlwbavgFuelingtime"));
			BigDecimal val = new BigDecimal(AvgFuelingTimeperUnitmins.getText());
			DecimalFormat decimalFormat = new DecimalFormat("0.0");
			String numberAsString = decimalFormat.format(val);
			
			ExcelUtils.setCellData(numberAsString, 62, colnum);

			System.out.println("Avg. Fueling Time Per Unit min " + numberAsString);
			test1.info("Avg. Fueling Time Per Unit min " + numberAsString);

			WebElement FueledUnits=driver.findElement(By.id("ltlwbFueledUnits"));
			ExcelUtils.setCellData(FueledUnits.getText(), 63, colnum);

			System.out.println("# Fuel Units is " + FueledUnits.getText());
			test1.info("# Fuel Units is " + FueledUnits.getText());

			WebElement TotalTimeperDelmins=driver.findElement(By.id("ltlwblblTimePerDelivery"));
			ExcelUtils.setCellData(TotalTimeperDelmins.getText(), 64, colnum);
			...
			WebElement AvgMarginFreightDel=driver.findElement(By.id("ltlwbFrietPerDelivery"));
			ExcelUtils.setCellData(AvgMarginFreightDel.getText(), 65, colnum);
			...
			WebElement GrossMarginHour=driver.findElement(By.id("ltlwblblTotalTimetooltip"));
			ExcelUtils.setCellData(GrossMarginHour.getText(), 66, colnum);

			System.out.println("Gross Margin $/Hour is " + GrossMarginHour.getText());
			test1.info("Gross Margin $/Hour is " + GrossMarginHour.getText());

			WebElement Distance=driver.findElement(By.id("lblDistance1"));
			ExcelUtils.setCellData(Distance.getText(), 67, colnum);
	...
	public  void Verify_finaltotal_and_RankingBasis_Values() throws Exception{
		...
		try {
			...
			test1.info("Final Total has value as " + finaltotal.getText());

			ExcelUtils.setCellData(finaltotal.getText(), 70, colnum);
			...
			ExcelUtils.setCellData(rankingbasis.getText(), 74, colnum);

			String excepted=ExcelUtils.getCellData(70, colnum);
